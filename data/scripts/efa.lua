...
-- Âåòğîãåíåğàòîğ
if WINDGENERATOR_TIME_HOUR_GLOBAL == nil then
	WINDGENERATOR_TIME_HOUR_GLOBAL = 0
end

if WINDGENERATOR_TIME_MINUTE_GLOBAL == nil then
	WINDGENERATOR_TIME_MINUTE_GLOBAL = 0
end

if WINDGENERATOR_TIME_SECOND_GLOBAL == nil then
	WINDGENERATOR_TIME_SECOND_GLOBAL = 0
end

if WINDGENERATOR_STATUS_GLOBAL == nil then
	WINDGENERATOR_STATUS_GLOBAL = 0
end
...
-- Äàòü ïàòğîíû äëÿ êîíêğåòíîãî îğóæèÿ
...
-- Ğàíäîìíàÿ êîíôèãóğàöèÿ ìàøèíû èãğîêà
...
-- Ñîêğàùåííàÿ ôóíêöèÿ âûâîäà ñîîáùåíèÿ â êîíñîëü
function con(msg)
	println(msg)
end

-- Áåçîïàñíàÿ ñìåíà ñêèíà ó îáúåêòà
...
-- Äîáàâèòü ìàøèíó â ãîğîä åñëè íå âûïîëíåí êîíêğåòíûé êâåñò
...
-- Äîáàâèòü êàáèíó èëè êóçîâ â ãîğîä
...
-- Äîáàâèòü êàáèíó èëè êóçîâ â ãîğîä åñëè íå âûïîëíåí êîíêğåòíûé êâåñò
...
-- Âûäàòü èãğîêó ñëó÷àéíûé ïğåäìåò èç ñïèñêà, ëèáî âûäàòü äåíüãè
...
-- Âûäàòü èãğîêó ñëó÷àéíûé ïğåäìåò èç ñïèñêà
...
-- Äîáàâèòü ïğåäìåòû â êóçîâ ìàøèíû åñëè òàì åñòü ìåñòî
...
-- Ãåíåğàöèÿ ñëó÷àéíîãî èìåíè äëÿ äèêîãî
function GenerateRandomScavName()
	local firstName = {"Èâàí", "Äìèòğèé", "Äèìà", "Äèìêà", "Àéâåí", "Àéâàíû÷", "Áåí", "Âèòàëèé", "Âèòàëèê", "Âèòàëÿ", "Âàñÿ", "Ïèñÿ", "Ìàêñèì", "Àøîò", "Ôåäÿ", "Ôåğäèíàíä", "Ñàíÿ", "Ñàíüêà", "Èëüÿ", "Èëşõà", "Ëåõà", "Ïåòüêà", "Ñàâåëèé", "Âàëåğèé", "Êèñà", "Êîò", "Äåä", "Ìîøåííèê", "Ïàïè÷", "Ïàâåë", "Ïàâëèê", "Âèò¸ê", "Âàíòóç", "Äàíÿ", "Äàíèëà", "Äèìîí", "Êèğşõà", "Áîğÿ", "Áîğèñ", "Êàáàí", "Ìàêñ", "Êàğñåí", "Àëèê", "Ïàøêà", "Âîâàí", "Àíàòîëèé", "Ñò¸ïà", "Ìûø", "Ìóæ", "Àêñåëü", "Ôåëèêñ", "Âîğ", "Äèê", "Ìèõà", "Ìèõàèë", "Ğîñòèñëàâ", "Êîëÿí", "Êîëÿ", "¨áûğü", "Èãğîê", "Ï¸òğ", "Ïåòğóõà", "Äîä", "Ïåòğîâè÷", "Àëåêñ", "Àëåêñåé", "Ñåğãåé", "Ñåğ¸ãà", "Ñåğãî", "Ãíîì", "Äğóèä", "Áàíäèò", "Áğîäÿãà", "Êî÷åâíèê", "Ğàáîòÿãà", "Àìåğèãî", "Ñıì", "Êîííè", "Áëàéä", "Äğîíí", "Ñåğûé", "Òàëèê", "Ãèò", "Ñâÿòîñëàâ", "Ìèñòåğ", "Êîò", "Ñàí¸ê", "Òèì", "Ìèøàíÿ", "Ô¸äîğ", "Âàñÿí", "Íèêèòà", "Íèêèòêà", "Ìîíîëèò", "Ñòàíèñëàâ", "Ñòàñ", "Ñòàñÿí", "Ñòàêàí"}
	local secondName = {"Ñëàáûé", "Ñèëüíûé", "Ìîùíûé", "Ìåòêèé", "Ñêîğîñòğåë", "Æåëåçíûé", "Áğîíèğîâàííûé", "Íåóäà÷íèê", "Íàğêîìàí", "Áåëàçèñò", "Íàòóğàë", "ĞÏÃ", "Ãóñàê", "Äèêàğü", "Ñìåòàíà", "Áàçèğîâàííûé", "Ïğîãğàììèñò", "Àéòèøíèê", "Îïàñíûé", "Ñòğàøíûé", "Êğåïêèé", "Óëó÷øåííûé", "Àïãğåéäíóòûé", "Ìîğÿê", "Åáàíüêî", "Ãåğîé", "Íîâè÷îê", "Áûâàëûé", "Ïğîôè", "Ìàñòåğ", "Âîäèëà", "Àíàíàãà", "Áîá¸ğ", "Âåğòóõàé", "Çàäíåïğèâîäíûé", "Ìğà÷íûé", "Êèáåğïñèõ", "Êèáåğñïîğòñìåí", "Òîğãîâåö", "Áàğìåí", "Îğàêóë", "Íàğêîòîğãîâåö", "Íåíàğêîòîğãîâåö", "Íàğêîìàí", "Êåïêà", "Êåïàğèê", "Ğûõëûé", "Êàçàõ", "Ñàìóğàé", "ßïîí÷èê", "Ïîí÷èê", "Ñëàäêèé", "Áîòàí", "Ñôåíî", "Çàòâîğ", "Ïîìîùíèê", "Êóñîê", "Ñïğóò", "Ğåéíìåòàëë", "Ôàãîò", "Ñêîğîñòíîé", "ßéöî", "Óïèòûø", "Êğåïûø", "Êëîóí", "Áåáğà", "ßåáó", "Ïğàâèëüíûé", "×ÑÂ", "Ïîëòîğàøêà", "Áèãìàê", "Ìèêğîôîí", "Âèáğèğóşùèé", "Ğàçğÿäíèê", "Íÿøêà", "Ìå÷åíûé", "Ïóõ", "Ìîçãîëşá", "Ëåâûé", "Ïğàâûé", "Ôåğìåğ", "Ìîêğûé", "Âëàæíûé", "Íàãëûé", "Ãëóøèòåëü", "×àğëè", "Êàïåö", "Ïèçäşê", "Ãîíäóğàñ", "Îâîùåáàçà", "Ñèñüêà", "Êîìïàò÷åğ", "Øèçà", "Îáåçüÿíà", "Äğèñòîì¸ò", "Èâàíû÷", "Èâàíîâ", "Áàğûãà", "Îäíîãëàçûé", "Åáó÷èé", "Âåçóí÷èê", "Êğèïòî", "Ìÿêèø", "Ìàõèíèñò", "Ãî", "Äğîññåëü", "Èä¸ò", "Çàìóçèê", "Êğóòîé", "Ëşáèòåëü", "Ïîåäàòåëü", "Ïğåäàòåëü", "Áåëàç", "Ñêàóò", "Áîåö", "Òàğàêàí", "Êëîï", "Ìóğàâåé", "Ìåäâåäü", "Îõîòíèê", "Óğàë", "Ñàãèòòà", "Ôèëèìîí", "Îòâåğñòâèå", "Ñêîğá", "Êàçèíî", "Ãåíåğàòîğ", "Òåğìèíàòîğ", "Ñòğàííèê", "Ìëàäøèé", "Ñòàğøèé", "Áåíçîáàê", "Ãğóçèí", "Äûğÿâûé", "Ñíàéïåğ", "Êğèï", "Êğèïòî", "Ãğóñòíûé", "Øëÿïà", "Çàâîäñêîé", "Ïàøòåò", "Àğàõèñ", "Óìíèê", "Äîòåğ", "Áóÿíîâ", "Ìóäğûé", "Äîëáîÿùåğ"}
	local Name = ""..firstName[random(getn(firstName))].." "..secondName[random(getn(secondName))]..""

	return Name
end

-- Âîçâğàùàåò àéòåì ñ îïğåäåëåííûì øàíñîì
...
-- Îòñëåæèâàíèå ïîïàäàíèé ïî öåëè
...
-- Ïğîâåğêà, åñòü ëè â êóçîâå èãğîêà ìåñòî ïîä óñòàíîâëåííûå ãàäæåòû
...
-- Äîáàâèòü ñïèñîê ïğåäìåòîâ â êóçîâ èãğîêà
...
-- Ğàçìåñòèòü ïğåäìåò íà ñòåëëàæå
...
-- Óñòàíîâèòü íîâóş êàáèíó ñ ñîõğàíåíèåì áğîíè
...
-- Ïğîâåğêà, óñòàíîâëåíî ëè êîíêğåòíîå âîîğóæåíèå
...
-- Âêëş÷èòü/âûêëş÷èòü ñïàâí äåôîëòíûõ ìàøèí ó áîññà Âèòàëè
...
-- Âûïîëíèòü ïîäçàäà÷ó, åñëè var ïåğåìåííàÿ ğàâíà îïğåäåëåííîìó çíà÷åíèş
...
-- Ôóíêöèÿ êëàä¸ò â êóçîâ îğóæèå ñî ñëó÷àéíûì àôôèêñîì
...
-- Âîçâğàùàåò 1 ñ îïğåäåëåííûì øàíñîì â çàâèñèìîñòè îò êàğìû äèêîãî
